package com.projetenchere.Manager.View.graphicalUserInterface.Item;
...
public class ManagerTable {
    ...
    public ManagerTable(String id, String nom, String description, String debut, String fin, String status) {
        this.id = id;
